...
public class GlobalBlockPalette {
    ...
    static {
        ...
        for (CompoundTag state : tag.getAll()) {
            ...
            for (int val : meta) {
                ...
                idToName.put(legacyId, name + ":" + val);
            }
    ...
    public static String getName(int runtimeId) throws NoSuchElementException {
        String name = idToName.get(runtimeId);
        if (name == null) {
            throw new NoSuchElementException("Unmapped block registered runtime id: " + runtimeId);
        }
        return name;
    }
